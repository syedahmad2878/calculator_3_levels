...
# It's good practice to add a docstring at the beginning of the module explaining
...
@pytest.mark.parametrize("a, b, operation, expected", [
    ...
    (Decimal('10.5'), Decimal('0.5'), add, Decimal('11')),
...
def test_calculation_operations(a, b, operation, expected):
    ...
    Parameters:
     ...
     operation (function): The operation to perfom.
...
def test_calculation_repr():
    ...
    assert calc.__repr__() == expected_repr, "The __repe__method outpu does not match expectation"

def test_divide_by_zero():
    """
    Test division by zero to ensure it raises a Value Error.
    """
